...
export const EVENT_RECURRENCE_RULES = ['daily', 'weekly', 'fortnightly', 'monthly', 'yearly'] as const;
export type EventRecurrenceRule = (typeof EVENT_RECURRENCE_RULES)[number];
